...
export function CardContent({...props}:CardContentProps) {
	return (
		<article className={props.lastItem ? `bg-very-light-peach mb-[311px] sm:overflow-hidden sm:rounded-[15px] md:flex md:flex-row-reverse md:items-center` : `bg-very-light-peach sm:overflow-hidden sm:rounded-[15px] md:flex md:items-center`}>
