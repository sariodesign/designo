...
export function HeroContact({...props}:HeroContactProps) {
	return (
		<div className="bg-peach bg-hero-pattern bg-no-repeat bg-left-bottom flex flex-col overflow-hidden py-[72px] px-6 text-center text-white sm:text-left sm:rounded-[15px] md:flex-row md:py-[56px]">
